...
export function Layout() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 flex justify-center w-full">
      <div className="min-h-screen bg-canvas relative max-w-md mx-auto w-full shadow-2xl border-x border-border-subtle flex flex-col">
