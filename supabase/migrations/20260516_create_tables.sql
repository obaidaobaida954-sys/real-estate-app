...
-- Create RLS policies for admin write access (through service role or authenticated users)
-- Note: These policies assume an 'is_admin' field or similar authentication mechanism
-- For development, you can temporarily allow all inserts, but this should be restricted in production
